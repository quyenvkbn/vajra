...
class Location extends Public_Controller {
    ...
    public function index() {
        ...
        $this->data['result'] = $this->localtion_model->get_all_with_pagination_searchs('desc', $per_page, $this->data['page'],$this->data['keyword'],$this->data['category']);
    ...
    public function detail($slug){
        ...
        $this->data['localtion_array'] = $this->localtion_model->get_all_localtion_area($this->data['detail']['area_id'],$this->data['detail']['id'],3);
