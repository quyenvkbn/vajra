...
class Product extends Admin_Controller{
    ...
    public function index(){
        ...
        $this->data['hot'] = '';
        $this->data['promotion'] = '';
        if($this->input->get('hot') || $this->input->get('bestselling') || $this->input->get('promotion')){
        ...
        $per_page = 10;
        $total_rows  = $this->product_model->count_search($this->data['keyword'],1,$this->data['bestselling'],$this->data['hot'],$this->data['promotion']);
        $config = $this->pagination_config(base_url('admin/'.$this->data['controller'].'/index'), $total_rows, $per_page, 4);
        $this->data['page'] = ($this->uri->segment(4)) ? $this->uri->segment(4) : 0;
        $this->pagination->initialize($config);
        $this->data['page_links'] = $this->pagination->create_links();
        $this->data['result'] = $this->product_model->get_all_with_pagination_search('desc', $per_page, $this->data['page'], $this->data['keyword'],1,$this->data['bestselling'],$this->data['hot'],$this->data['promotion']);
