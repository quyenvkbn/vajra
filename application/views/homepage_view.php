						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="inner cover col-xs-12 col-sm-6 col-md-4">
									<div class="mask">
										<img src="<?php echo base_url('assets/upload/product_category/'.$domestic['slug'].'/'.$domestic['image']); ?>" alt="domestic cover image">
							...
							<div class="item active">
								<div class="inner cover col-xs-12 col-sm-6 col-md-4">
									<div class="mask">
										...
										<img src="<?php echo base_url('assets/upload/product_category/'.$international['slug'].'/'.$international['image']); ?>" alt="international cover image">
