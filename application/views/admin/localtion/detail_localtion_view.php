                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        <ul class="nav nav-tabs" role="tablist" id="nav-product">
                            <li role="presentation" class="<?php echo ($this->uri->segment(5) == '' && !isset($_GET['active']))? 'active' : '' ?>"><a href="#blog" class="btn btn-primary" aria-controls="tour" role="tab" data-toggle="tab">Địa điểm</a></li>
